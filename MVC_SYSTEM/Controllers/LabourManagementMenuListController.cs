...
namespace MVC_SYSTEM.Controllers
{
    ...
    public class LabourManagementMenuListController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            return View(await Masterdb.tblMenuLists.Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_Flag == "LabourManagementList" && x.fldDeleted == false).ToListAsync());
        }
