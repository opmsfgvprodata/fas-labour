...
namespace MVC_SYSTEM.Controllers
{
    ...
    public class LabourRequestMenuListController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            return View(await Masterdb.tblMenuLists.Where(x => x.fld_NegaraID == NegaraID && x.fld_SyarikatID == SyarikatID && x.fld_Flag == "LabourRequestList" && x.fldDeleted == false).ToListAsync());
        }
