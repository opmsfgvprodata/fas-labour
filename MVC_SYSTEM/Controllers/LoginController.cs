                ...
                if (string.IsNullOrEmpty(Login.fldUserName) == false && string.IsNullOrEmpty(Login.fldUserPassword) == false)
                {
                    ...
                    if (user != null)
                    {
                        if (user.fldNegaraID == 0 || user.fldSyarikatID == 0 || user.fldWilayahID == 0)
                        {
                            ...
                            //else
                            //{
                            //    ModelState.AddModelError("", GlobalResGeneral.lblLoginHQMsg);
                            //}
                        }
                        else
                        {
                    ...
                    {
                        ModelState.AddModelError("", GlobalResGeneral.lblLoginInvalid);
                    }
                }
                else
                {
                    ModelState.AddModelError("", GlobalResGeneral.lblInsertInput);
                }
            }
            catch (Exception ex)
            {
